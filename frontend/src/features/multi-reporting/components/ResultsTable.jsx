        ...
        <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden text-sm sm:text-base">
          <thead>
            <tr className="bg-gray-100 text-gray-700">
              <th className="px-4 py-2 text-center">Report File</th>
              <th className="px-4 py-2 text-center">Name</th>
              <th className="px-4 py-2 text-center">Age</th>
              <th className="px-4 py-2 text-center">Diagnosis</th>
              <th className="px-4 py-2 text-center">Treatment</th>
              <th className="px-4 py-2 text-center">Covered</th>
              <th className="px-4 py-2 text-center">Policy Clause</th>
              <th className="px-4 py-2 text-center">Limit</th>
              <th className="px-4 py-2 text-center">Confidence</th>
              <th className="px-4 py-2 text-center">Explain</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((r, i) => (
