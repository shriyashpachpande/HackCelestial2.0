...
export default function ReportUploader({ onUploaded, onRemoved }) {
    ...
    return (
        ...
        >
            <h3 className="text-lg sm:text-xl font-semibold mb-4 text-center text-blue-900">Reports</h3>
            ...
            >
                ...
                <small className="block mt-2 text-gray-500">
                    Allowed: .pdf, .txt, .png, .jpeg, .jpg, .doc, .docx
                </small>
            </div>
            ...
            <ul className="list-none p-0 m-0">
                {list.map((it, idx) => (
                    ...
                    >
                        <span>
                            {it.name} — {Math.round((it.size || 0) / 1024)} KB — {it.progress}
                        </span>
